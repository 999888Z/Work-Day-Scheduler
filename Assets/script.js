...
//created variables to display current date from day.js on page via html
...
//created empty variable to store ?
var dayTimes = [
  "9AM",
  "10AM",
  "11AM",
...
//created for loop to iterate through all hours of workday and if 
$(function () {
...
// created functions to retrieve stored input in each timeblock
...
$("#input-5PM").val(stored5PM)
  ...
  // created event listener to trigger local storage function upon clock of 
